...
from .criterion.relative_depth_margin_log_normal_depth import relative_depth_margin_log_normal_depth
def get_criterion(camera, g_args):
	return relative_depth_margin_log_normal_depth(g_args.w_n, g_args.margin, camera).cuda()
